...
const previousReport=JSON.parse(readFileSync("data/armor-integration/color-mechanic-audit.json","utf8"));
const previous={candidates:capture.evidence.candidates,audit:previousReport.audit};
const beforeSnapshot=JSON.parse(readFileSync("data/armor-integration/color-mechanic-audit.json","utf8"));
...
writeFileSync("data/armor-integration/inactive-replacement-mechanic-audit.json",JSON.stringify(report,null,2)+"\n");
