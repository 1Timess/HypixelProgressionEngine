...
const previousReport=JSON.parse(readFileSync("data/armor-integration/stat-label-mechanic-audit.json","utf8"));
const previous={candidates:capture.evidence.candidates,audit:previousReport.audit};
const beforeSnapshot=JSON.parse(readFileSync("data/armor-integration/stat-label-mechanic-audit.json","utf8"));
...
writeFileSync("data/armor-integration/gemstone-mechanic-audit.json",JSON.stringify(report,null,2)+"\n");
