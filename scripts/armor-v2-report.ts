...
const previous=narrowArmorFrontier(e,catalog,Date.parse(capture.historicalEvaluationTime),knowledge);
const beforeSnapshot=JSON.parse(readFileSync("data/armor-integration/set-resumption-audit.json","utf8"));
...
writeFileSync("data/armor-integration/v2-mechanic-audit.json",JSON.stringify(report,null,2)+"\n");
